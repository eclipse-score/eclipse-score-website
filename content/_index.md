...
<main
      class="main-section homepage-main-section p-0 min-vh-100 d-flex flex-column"
    >
      <div >
        <div class="section main-header-container">
          <header class="main-header w-100">
            ...
            >
              <div class="container px-3">
                <div class="navbar-content">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul
                      class="navbar-nav me-auto mb-2 mb-lg-0 navigation-links"
                    >
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="training-modules.html"
                          >Join us</a
                        >
                      </li>
                      <li class="nav-item">
              ...
              >               
                <a
                  href="https://github.com/eclipse-score" class="github-link ms-2" aria-label="Visit our GitHub" target="_blank" rel="noopener noreferrer">
            ...
            <section
                  href="https://github.com/eclipse-score" target="_blank" and rel="noopener noreferrer" class="header-content w-100 flex-grow-1 d-flex align-items-center py-5">
              <div class="container">
                <div class="row g-4 w-100 align-items-center">
                  <div class="col-12 col-lg-7 mb-4 mb-lg-0 text-content">
                    <h2 class="main-heading mb-3">
                      <span>From</span> <span>Proprietary</span>
                      <span>To</span> <span>Open</span> <span>Source</span>
                    </h2>
                    <p class="description">
                    ...
                    <div class="cta-section mt-4">
                      ...
                      <div class="cta-buttons d-flex flex-wrap gap-2">
                        <a href="training-modules.html" class="btn btn-primary button primary"
                          >Explore the projects</a
                        >
                        <a
                          href="reference-implementation.html"
                          class="btn btn-outline-primary button secondary"
                          >Get Involved</a
                        >
                        <a
                          href="https://github.com/eclipse-score" target="_blank" rel="noopener noreferrer"
                          class="btn btn-outline-primary button tertiary"
                          >Visit Our Github</a
                        >
                      </div>
                    </div>
                  ...
                  <div class="col-12 col-lg-5 d-flex align-items-center">
                    <img
                      ...
                      alt="3D illustration of a futuristic car with floating cubes"
                    />
                  </div>
                </div>
              </div>
          ...
          <section class="esc-section esc-nutshell-section">
            <div class="container">
              <div class="esc-header esc-header-nutshell mb-5">
                <h2 class="h2">S-CORE Release Milestones</h2>
              </div>

              <div class="row g-4 justify-content-center">
                <div class="col-12 col-md-6 col-xl-3">
                  <div
                    class="main-transparent-card needed-card d-flex align-items-center justify-content-center flex-column gap-3"
                  >
                    <div
                      class="icon d-flex align-items-center justify-content-center"
                    >
                      <img src="images/icons/release.png" alt="" />
                    </div>
                    <h5>Release Notes</h5>
                    <p>
                      ...
                      <a
                        ...
                        href="https://eclipse-score.github.io/score/main/score_releases/score_releases/index.html" target="_blank" rel="noopener noreferrer"
                      >
                        Release Notes
                      </a>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                  ...
                  >
                    <div
                      class="icon d-flex align-items-center justify-content-center"
                    >
                      <img src="images/icons/discussion.png" alt="" />
                    </div>
                    <h5>Get in touch</h5>
                    <p>
                      ...
                      <a
                        class="read-more btn btn-primary main-primary mt-4 d-inline-block text-center"
                        href="reference-implementation.html" rel="noopener noreferrer"
                      >
                        Get in touch
                      </a>
          ...
          <section class="esc-section esc-news-section">
            <div class="container">
              <div class="esc-header esc-header-news mb-5">
                ...
                <a
                  href="news.html"
                  class="d-inline-flex ms-auto align-items-center justify-content-center header-link gap-2">
              ...
              <div class="esc-content">
                <div class="owl-carousel-wrapper position-relative">
                  ...
                  <!-- ========== Begin Card ========== -->
                    ...
                    <div class="card">
                      <div class="card-img">
                        <img src="images/icons/QC joins.png" width="1.5" height="05"/>
                      </div>
                      <div class="card-body p-0 py-4">
                      ...
                      <div class="card-actions">
                        <a class="learn-more" href="https://eclipse.dev/score/press_releases.html" target="_blank" and rel="noopener noreferrer"
                          >Learn More
                          <div class="icon">
                            <img src="images/icons/right-arrow.svg" alt="" />
                          </div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-actions">
                        <a class="learn-more" href="https://www.eventbrite.com/e/eclipse-sdv-community-meetup-japan-co-hosted-by-bosch-group-tickets-1540218427779" target="_blank" and rel="noopener noreferrer"
                          >Learn More
                          <div class="icon">
                            <img src="images/icons/right-arrow.svg" alt="" />
                          </div>
            ...
            <div class="container">
              ...
              <div class="esc-content">
                ...
                <div class="row g-4 justify-content-center mb-5">
                  <div class="col-12 col-md-6 col-xl-3">
                    <div
                      class="main-white-card nutshell-card d-flex align-items-center justify-content-center flex-column gap-3"
                    >
                      <div
                        class="icon d-flex align-items-center justify-content-center"
                      >
              ...
              <div class="esc-content">
                <div class="zoom-image-wrapper">
                  <div class="panzoom-container">
                    <img
                      src="images/home/safety-critical.png"
                      alt=""
                      class="zoom-image"
                    />
                  </div>
            ...
            <div class="container">
              ...
              <div class="esc-content">
                <div class="zoom-image-wrapper">
                  <div class="panzoom-container">
                    <img
                      src="images/home/platform-layers-3x.png"
                      alt=""
                      class="zoom-image"
                    />
                  </div>
            ...
            <div class="container">
              ...
              <div class="esc-content">
                <div class="zoom-image-wrapper">
                  <div class="panzoom-container">
                    <img
                      src="images/home/deliverables.png"
                      alt=""
                      class="zoom-image"
                    />
                  </div>
