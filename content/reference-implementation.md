...
<header class="main-pages-header campus-page-header w-100">
      <nav
      ...
      >
        <div class="container">
          <div class="pages-title">
            <h2 class="h2 text-white">Join us</h2>
          </div>
    ...
    <main class="main-section p-0 d-flex flex-column">
        ...
        <div class="container">
          <div class="nav-tabs-wrapper">
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="reference-implementation.html"
                  >How to Contribute</a
                >
              </li>
              <li class="nav-item">
      ...
      <section
        class="esc-section esc-reference-implementations-container-section pt-0">
        <div class="container">
          <div class="pages-title mb-4">
            ...
            <p class="max-w-100">
             If you want to get into contact with S-CORE, these are your primary entry points: <br><br>
